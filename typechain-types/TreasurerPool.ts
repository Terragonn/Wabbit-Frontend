...
export interface TreasurerPoolInterface extends utils.Interface {
  contractName: "TreasurerPool";
  functions: {
...
export interface TreasurerPool extends BaseContract {
  contractName: "TreasurerPool";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasurerPoolInterface;
