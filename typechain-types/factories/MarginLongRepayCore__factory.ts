...
import type {
  MarginLongRepayCore,
  MarginLongRepayCoreInterface,
} from "../MarginLongRepayCore";
...
export class MarginLongRepayCore__factory {
  static readonly abi = _abi;
  static createInterface(): MarginLongRepayCoreInterface {
    return new utils.Interface(_abi) as MarginLongRepayCoreInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarginLongRepayCore {
    return new Contract(address, _abi, signerOrProvider) as MarginLongRepayCore;
  }
}
