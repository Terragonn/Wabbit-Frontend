...
import type {
  MarginLongLiquidate,
  MarginLongLiquidateInterface,
} from "../MarginLongLiquidate";
...
export class MarginLongLiquidate__factory {
  static readonly abi = _abi;
  static createInterface(): MarginLongLiquidateInterface {
    return new utils.Interface(_abi) as MarginLongLiquidateInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarginLongLiquidate {
    return new Contract(address, _abi, signerOrProvider) as MarginLongLiquidate;
  }
}
