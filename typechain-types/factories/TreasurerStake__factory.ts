...
export class TreasurerStake__factory {
  static readonly abi = _abi;
  static createInterface(): TreasurerStakeInterface {
    return new utils.Interface(_abi) as TreasurerStakeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TreasurerStake {
    return new Contract(address, _abi, signerOrProvider) as TreasurerStake;
  }
}
