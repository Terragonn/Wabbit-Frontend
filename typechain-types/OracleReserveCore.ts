...
export interface OracleReserveCoreInterface extends utils.Interface {
  contractName: "OracleReserveCore";
  functions: {
...
export interface OracleReserveCore extends BaseContract {
  contractName: "OracleReserveCore";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OracleReserveCoreInterface;
