...
export interface OracleLPInterface extends utils.Interface {
  contractName: "OracleLP";
  functions: {
...
export interface OracleLP extends BaseContract {
  contractName: "OracleLP";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OracleLPInterface;
