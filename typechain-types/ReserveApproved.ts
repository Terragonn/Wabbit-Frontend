...
export interface ReserveApprovedInterface extends utils.Interface {
  contractName: "ReserveApproved";
  functions: {
...
export interface ReserveApproved extends BaseContract {
  contractName: "ReserveApproved";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveApprovedInterface;
