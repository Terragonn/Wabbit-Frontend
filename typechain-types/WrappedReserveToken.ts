...
export interface WrappedReserveTokenInterface extends utils.Interface {
  contractName: "WrappedReserveToken";
  functions: {
    ...
    "initializeWrappedReserveToken(string,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "initializeWrappedReserveToken",
    values: [string, string]
  ): string;
  encodeFunctionData(
...
export interface WrappedReserveToken extends BaseContract {
  contractName: "WrappedReserveToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WrappedReserveTokenInterface;
