...
export interface TimelockFlattenedInterface extends utils.Interface {
  contractName: "TimelockFlattened";
  functions: {
...
export interface TimelockFlattened extends BaseContract {
  contractName: "TimelockFlattened";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TimelockFlattenedInterface;
