...
export interface FlashLoanTestInterface extends utils.Interface {
  contractName: "FlashLoanTest";
  functions: {
...
export interface FlashLoanTest extends BaseContract {
  contractName: "FlashLoanTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlashLoanTestInterface;
