...
export interface ReserveTreasuryLiquidityInterface extends utils.Interface {
  contractName: "ReserveTreasuryLiquidity";
  functions: {
...
export interface ReserveTreasuryLiquidity extends BaseContract {
  contractName: "ReserveTreasuryLiquidity";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveTreasuryLiquidityInterface;
