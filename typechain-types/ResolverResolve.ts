...
export interface ResolverResolveInterface extends utils.Interface {
  contractName: "ResolverResolve";
  functions: {
...
export interface ResolverResolve extends BaseContract {
  contractName: "ResolverResolve";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResolverResolveInterface;
