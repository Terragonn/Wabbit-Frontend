...
export interface ReserveTokenWrappedInterface extends utils.Interface {
  contractName: "ReserveTokenWrapped";
  functions: {
    ...
    "initializeReserveTokenWrapped(string,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "initializeReserveTokenWrapped",
    values: [string, string]
  ): string;
  encodeFunctionData(
...
export interface ReserveTokenWrapped extends BaseContract {
  contractName: "ReserveTokenWrapped";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveTokenWrappedInterface;
