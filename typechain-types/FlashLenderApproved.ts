...
export interface FlashLenderApprovedInterface extends utils.Interface {
  contractName: "FlashLenderApproved";
  functions: {
...
export interface FlashLenderApproved extends BaseContract {
  contractName: "FlashLenderApproved";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlashLenderApprovedInterface;
