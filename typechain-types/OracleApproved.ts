...
export interface OracleApprovedInterface extends utils.Interface {
  contractName: "OracleApproved";
  functions: {
...
export interface OracleApproved extends BaseContract {
  contractName: "OracleApproved";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OracleApprovedInterface;
