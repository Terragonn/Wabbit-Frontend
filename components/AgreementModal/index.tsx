    ...
    return (
        <div className={`${agreed ? "hidden" : ""} bg-black bg-opacity-80 fixed inset-0 flex items-center justify-center z-50 modal`}>
            <div className="mx-auto lg:w-2/5 w-4/5 min-w-min bg-neutral-900 glow rounded-xl p-6">
                ...
                <div className="text-neutral-400 font-medium border-b-2 pb-5 border-b-neutral-800 border-opacity-30 space-y-3">
                    <p>By using this app you acknowledge the risks of cryptocurrencies, tokens, smart contracts, and leveraged trading.</p>
                    <p>You acknowledge that using this app is risky and that you are responsible for ALL losses incurred on the platform.</p>
                    <p>
                        You have read through the{" "}
                        <a href="https://docs.torque.money" className="font-bold text-neutral-300 hover:text-neutral-200">
                            documentation
                        </a>{" "}
                        thoroughly and are confident in your understanding of how the protocol functions.
                    </p>
                </div>
