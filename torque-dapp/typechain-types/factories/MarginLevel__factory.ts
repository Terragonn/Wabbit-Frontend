...
import type { MarginLevel, MarginLevelInterface } from "../MarginLevel";
...
export class MarginLevel__factory {
  static readonly abi = _abi;
  static createInterface(): MarginLevelInterface {
    return new utils.Interface(_abi) as MarginLevelInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarginLevel {
    return new Contract(address, _abi, signerOrProvider) as MarginLevel;
  }
}
