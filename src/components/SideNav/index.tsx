...
export default function SideNav() {
    return (
        <nav className="fixed top-0 left-0 h-screen w-80 bg-neutral-900 p-5 shadow-lg shadow-fuchsia-500">
            <Link to="dashboard/leverage">
                <img src={require("../../images/logo1.png")} width={200} className="pt-5 mx-auto" />
            </Link>
