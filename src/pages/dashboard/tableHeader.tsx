export default function TableHeader() {
    return (
        <div className="flex items-center justify-evenly py-3 px-10 mb-2">
            ...
            <h3 className="text-center w-full text-neutral-500 font-bold lg:block hidden">TVL</h3>
            <h3 className="text-center w-full text-neutral-500 font-bold lg:block hidden">Borrowed</h3>
            <h3 className="text-center w-full text-neutral-500 font-bold lg:hidden">Available</h3>
