...
import type { MarginAccount, MarginAccountInterface } from "../MarginAccount";
...
export class MarginAccount__factory {
  static readonly abi = _abi;
  static createInterface(): MarginAccountInterface {
    return new utils.Interface(_abi) as MarginAccountInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarginAccount {
    return new Contract(address, _abi, signerOrProvider) as MarginAccount;
  }
}
